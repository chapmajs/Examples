...
# Additionally modified by glitch@glitchwrks.com to use a single host, also not compatible
# with python3
...
options = OptionParser(usage='%prog host', description='Test for SSL heartbeat vulnerability (CVE-2014-0160) on single host')
